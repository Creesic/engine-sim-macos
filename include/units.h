...
// PORT NOTE (M0 macOS bring-up): see constants.h for why the original
// `extern constexpr` declarations (ODR-violating duplicate-symbol
// definitions across translation units) were changed to `inline constexpr`
